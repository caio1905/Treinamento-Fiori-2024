		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#acnbtpui5treinamento-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"acnbtpui5treinamento-display": {
								"semanticObject": "acnbtpui5treinamento",
								"action": "display",
								"description": "Aplicação para treinamento Stellantis",
								"title": "Relatório Geral",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acn.btpui5treinamento",
									"url": sap.ui.require.toUrl("acn/btpui5treinamento")
								}
							}
						}
					}
